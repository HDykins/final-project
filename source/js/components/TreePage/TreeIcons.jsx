...
var TreeIcons = React.createClass({
  ...
  render: function () {
    return (
	<div className="row">
		<TreeIcon handleClick={this.changeToNorwegianView} label="Norwegian Spruce" price="£20-40" image="./build/images/tree-photos/norwegian-spruce.jpg" className={TreeInformationStore.getCurrentTreeView() === "NORWEGIAN_SPRUCE" ? "highlight" : null} />
		<TreeIcon handleClick={this.changeToNordmannView} label="Nordmann Fir" price="£28-48" image="http://www.keelechristmastreefarm.co.uk/img/nordmann-fir.jpg" className={TreeInformationStore.getCurrentTreeView() === "NORDMANN_FIR" ? "highlight" : null} />
