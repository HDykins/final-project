...
var TreeIcons = React.createClass({
  ...
  render: function () {
    return (
	<div className="row">
		<TreeIcon handleClick={this.changeToNorwegianView} label="Norwegian Spruce" price="£20-40" image="../../images/tree-photos/norwegian-spruce.jpg" className={TreeInformationStore.getCurrentTreeView() === "NORWEGIAN_SPRUCE" ? "highlight" : null} />
